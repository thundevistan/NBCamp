...
object ContactManager {
    ...
    init {
        addContact(ContactItem(R.drawable.img_profile, "daeulzzang1", "Home", true, "010-1111-8598", "ball1241@naver.com", "10분후에 알림"))
        ...
        addContact(ContactItem(R.drawable.img_profile, "daeulzzang4", "Home", true, "010-4444-8598", "ball1241@naver.com", "10분후에 알림"))
        addContact(ContactItem(R.drawable.img_profile, "daeulzzang5", "Home", true, "010-5555-8598", "ball1241@naver.com", "10분후에 알림"))
        ...
        addContact(ContactItem(R.drawable.img_profile, "daeulzzang8", "Home", true, "010-8888-8598", "ball1241@naver.com", "10분후에 알림"))
        addContact(ContactItem(R.drawable.img_profile, "daeulzzang9", "Home", false, "010-9999-8598", "ball1241@naver.com", "10분후에 알림"))
        addContact(ContactItem(R.drawable.img_profile, "daeulzzang10", "Home", true, "010-0000-8598", "ball1241@naver.com", "10분후에 알림"))
    }
